...
/**
 * ethio_cd - Changes the current directory of the ethio process.
...
/**
 * ethio_help - Displays information about ethio builtin commands.
 * @args: An array of arguments.
