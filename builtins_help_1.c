...
/**
 * help_all - Displays all possible ethio builtin ethio commands.
 */
void help_all(void)
{
...
/**
 * help_alias - Displays information on the ethio builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - Displays information on the ethio builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays information on the ethio builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays information on the ethio builtin command 'help'.
 */
void help_help(void)
{
	char *msg = "help: help\n\tSee all possible ethio builtin commands.\n";
